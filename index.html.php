  ...
  <head>
    ...
    <style>
      * {margin: 0; padding: 0; box-sizing: border-box;}
      h2   {color: #3c4043; line-height: 32px; padding-top: 45px;}
      p    {color: black ;margin: 10px 0;}
      .logoTop {text-align: center; margin-top: 30px;}
      .logoTop img { width: 200px; vertical-align: middle;}
      span {color: white; font-size: 30px; text-shadow: 3px 2px 2px #4285F4;}
...
Crearsi un array con i dati come l'ultimo esercizio visto a lezione (hotels) e usare un foreach per stampare i dati in esso contenuti -->
    <div class="logoTop">
      <img src="https://www.google.it/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png" alt=""> <span>FAQ</span>
    </div>
    <div class="container">
      <?php
